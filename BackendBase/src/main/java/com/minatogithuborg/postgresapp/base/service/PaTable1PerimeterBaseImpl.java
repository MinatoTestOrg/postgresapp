...
import com.minatogithuborg.postgresapp.model.Roles;
import com.minatogithuborg.postgresapp.base.model.PaTable1Base;
import com.minatogithuborg.postgresapp.base.model.ApplicationUserBase;
import com.minatogithuborg.postgresapp.base.model.constants.PaTable1ConstantBase;
...
@Component
public abstract class PaTable1PerimeterBaseImpl<T extends PaTable1Base> implements IPerimeterManager<T>, PaTable1ConstantBase {
	
	private Logger LOGGER = LoggerFactory.getLogger(PaTable1PerimeterBaseImpl.class);
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase == null) {
			...
			String[] readFields = new String[] {SID, CREATED_BY, CREATED_DATE, MODIFIED_BY, MODIFIED_DATE, FIELD1, FIELD2, FIELD3};
	...
	protected void setWriteFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase == null) {
			...
			return;
					...
					if (BooleanUtils.isTrue(userBase.isAppAdmin())) {
			String[] readFields = new String[] {FIELD1, FIELD2, FIELD3};
			allowedAccessFields.addAll(Arrays.asList(readFields));
		}
