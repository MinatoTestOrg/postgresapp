...
import com.minatogithuborg.postgresapp.base.model.constants.PaTable2ConstantBase;
...
@Component
public abstract class PaTable2PerimeterBaseImpl<T extends PaTable2Base> implements IPerimeterManager<T>, PaTable2ConstantBase {
	
	private Logger LOGGER = LoggerFactory.getLogger(PaTable2PerimeterBaseImpl.class);
