...
import com.minatogithuborg.postgresapp.base.service.IPaTable1BaseService;
...
public abstract class PaTable1BaseController<SERVICE extends IPaTable1BaseService<M>, M extends PaTable1Base>
		extends BaseWebService<SERVICE, M> {
	
	
	public PaTable1BaseController(SERVICE logic) {
		super(logic);
	}
