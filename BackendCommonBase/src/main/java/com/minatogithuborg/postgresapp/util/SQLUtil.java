package com.minatogithuborg.postgresapp.util;
...
public class SQLUtil {
	...
	private ResponseEntity generateAlterStatements() {
		String alterStatementsForMySQL = "ALTER TABLE `ApplicationUser` ADD CONSTRAINT `SIDUnique` UNIQUE (`sid`);"
 + NEWLINE + "ALTER TABLE `PaTable1` ADD CONSTRAINT `SIDUnique` UNIQUE (`sid`);"
 + NEWLINE + "ALTER TABLE `PaTable2` ADD CONSTRAINT `SIDUnique` UNIQUE (`sid`);"
;
		String alterStatementsForPostgres = "ALTER TABLE \"ApplicationUser\" ADD CONSTRAINT \"ApplicationUser_SIDUnique\" UNIQUE (\"sid\");"

 + NEWLINE + "ALTER TABLE \"PaTable1\" ADD CONSTRAINT \"PaTable1_SIDUnique\" UNIQUE (\"sid\");"

 + NEWLINE + "ALTER TABLE \"PaTable2\" ADD CONSTRAINT \"PaTable2_SIDUnique\" UNIQUE (\"sid\");"
...
;
	...
	private void generateSQLFile() {
		...
		metadataSources.addAnnotatedClass(PaTable1.class);
		metadataSources.addAnnotatedClass(PaTable2.class);
		metadataSources.addAnnotatedClass(RappitExposedAPIClients.class);
