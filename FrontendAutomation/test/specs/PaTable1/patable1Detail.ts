...
const testJSON = require('../../pageobjects/standardPageobjects/PaTable1/patable1Detail.json');
const testCustomJSON = require('../../pageobjects/customPageobjects/PaTable1/patable1Detail.json');
const mockData = require('../../mockData/PaTable1/patable1Detailmockdata.json')
