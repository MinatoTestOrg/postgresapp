...
const testJSON = require('../../pageobjects/standardPageobjects/PaTable2/patable2List.json');
const testCustomJSON = require('../../pageobjects/customPageobjects/PaTable2/patable2List.json');
const mockData = require('../../mockData/PaTable2/patable2Listmockdata.json')
