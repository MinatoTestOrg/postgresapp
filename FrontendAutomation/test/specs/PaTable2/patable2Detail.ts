...
const testJSON = require('../../pageobjects/standardPageobjects/PaTable2/patable2Detail.json');
const testCustomJSON = require('../../pageobjects/customPageobjects/PaTable2/patable2Detail.json');
const mockData = require('../../mockData/PaTable2/patable2Detailmockdata.json')
